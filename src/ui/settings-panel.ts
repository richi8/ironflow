/**
 * The settings: sound, size, motion, help and keys. See ironflow.md C30
 * tasks 1 and 3.
 *
 * For part of 2026-09-23 this panel was the menu, with SAVE & LOAD at its
 * top. It is a dialog again, opened by the menu's SETTINGS in the menu's
 * place (`game-menu.ts`), and the game stays paused behind it.
 *
