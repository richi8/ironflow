 ...
 *
 * ```text
 *   SAVE_VERSION = 4        MIGRATIONS = [v1 -> v2, v2 -> v3, v3 -> v4]
 * ```
 *
 * v2 (2026-09-23) added the player's hotbar layout to the metadata, and v3
 * (the same day) gave the player's bag positions, and v4 gave chests the
 * same. The
...
export const MIGRATIONS: readonly Migration[] = Object.freeze([v1ToV2, v2ToV3, v3ToV4]);
